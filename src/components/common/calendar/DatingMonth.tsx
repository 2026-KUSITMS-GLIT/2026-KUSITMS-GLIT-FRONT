...
function DatingMonthCaption({ className, ...props }: HTMLAttributes<HTMLSpanElement>) {
  return <span className={cn("body-3 text-white select-none", className)} {...props} />;
}

export { DatingMonthCaption, DatingMonthNav };
