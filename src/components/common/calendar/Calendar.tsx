...
import { DatingDay, DatingDayButton } from "./DatingDay";
import { DatingMonthCaption, DatingMonthNav } from "./DatingMonth";
import { DatingWeekday } from "./DatingWeekday";

type CalendarProps = React.ComponentProps<typeof DayPicker> extends infer Props
