  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <button
        ...
        className="rounded-12 mt-11.75 mb-2 flex min-h-40 w-full shrink-0 cursor-pointer flex-col items-start justify-start border-[0.3px] border-solid border-gray-800 bg-[linear-gradient(126deg,rgba(17,17,17,0.20)_6.6%,rgba(173,173,173,0.20)_106.5%)] px-4.5 pt-4 text-left">
